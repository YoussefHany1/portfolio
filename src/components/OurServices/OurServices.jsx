...
function OurServices() {
    ...
    return (
        <>
        <section className={`'our-services px-3 px-lg-5 ${styles.ourServices}`} id='services'>
            ...
            <div className="services d-flex flex-wrap p-5">
                <div className={`box col text-white mx-3 p-4 text-center rounded-3 mb-5 mb-md-0 ${styles.box}`}>
