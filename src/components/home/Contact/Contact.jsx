        ...
        <>
            <section className='contact px-4 lg:px-12 border-t border-gray-300/25' id='contact'>
                ...
                <div className="contact-content p-4 lg:p-12 lg:mx-5 flex flex-col lg:flex-row text-white items-center justify-between">
                    <form ref={form} onSubmit={sendEmail} className='form w-full text-center lg:mb-0 mb-12 lg:mr-5 lg:p-0 p-4 font-sans max-w-xl order-2 lg:order-none'>
                        ...
                        <input type="submit" value="Send" className='send mt-3 font-sans bg-[#cbcbcb1a] border border-gray-300/25 lg:duration-300 text-white rounded-md p-2 px-4 hover:[box-shadow:0_0_5px_var(--primary),_0_0_25px_var(--primary),_0_0_75px_var(--primary)]' />
                    </form>
                    <div className={`box flex flex-col items-center justify-between lg:p-12 p-4 rounded-md lg:mb-0 mb-12 bg-[#cbcbcb1a]`}>
                        ...
                        <button type="button" className={`download rounded-md p-4 font-sans border border-gray-300/25 lg:duration-300 hover:[box-shadow:0_0_5px_var(--primary),_0_0_25px_var(--primary),_0_0_75px_var(--primary)]`}>
                            <a href='https://drive.google.com/file/d/1p-dkLP_VNOLx5BYazsnrI8pHUaJA_oG8/view?usp=drive_link' target="_blank" className='text-white flex items-center'>
                                <lord-icon
