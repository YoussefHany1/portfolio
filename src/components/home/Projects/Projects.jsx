...
function Projects() {
    ...
    return (
        <>
            <section className={`projects px-3 lg:px-12 border-t border-gray-300/25 mb-10 pt-6 ${styles.projects}`} id='projects'>
                ...
                <div className="project-content p-5 flex flex-col items-center gap-12">
                    {/* first project */}
                    <div className={`projectBox relative flex justify-between items-center py-6 px-12 rounded-2xl lg:flex-row flex-col-reverse ${styles.projectBox}`}>
                        <div className="text text-white lg:pr4 lg:mt-0 mt-3 text-center lg:text-start">
                            ...
                            <p className='mb-2 lg:mr-18'>MegaMart is a modern, performance-optimized front-end e-commerce application designed to deliver a seamless shopping experience across devices. Built with Next.js and styled with Bootstrap, the project leverages both server-side rendering (SSR) and static site generation (SSG) to balance SEO needs and fast page loads.</p>
                            <button type="button" onClick={open1} className='bg-transparent rounded-full w-20 h-20'>
                            ...
                            <Dialog open={isOpen1} as="div" className="relative z-10 focus:outline-none" onClose={close1}>
                                <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                                    <div className="flex min-h-full lg:items-center justify-center py-5 px-6 lg:px-16">
                                        ...
                                        >
                                            <DialogTitle className="dialog-title flex items-center justify-between">
                                            ...
                                            <div className="dialog-body flex flex-wrap p-0 text-left">
                                                <div className={`description w-full lg:w-1/3 lg:pl-12 py-6 px-12 sticky top-0 text-white ${styles.description}`}>
                                                    ...
                                                    <div className={`inline-flex flex-wrap gap-6 pt-6 mb-6 lg:mb-0 ${styles.btnGroup}`}>
                                                        <a href='https://github.com/YoussefHany1/megamart' target='_blank' className='text-white flex items-center rounded-3xl p-1 px-2 border border-(--primary) hover:border-gray-300/25 duration-200'>
                                                            <lord-icon src="https://cdn.lordicon.com/lllcnxva.json" trigger="hover" colors="secondary:#16c72e"></lord-icon> Github Repository
                                                        </a>
                                                        <a href='https://megamart1.vercel.app/' target='_blank' className='text-white flex items-center rounded-3xl p-1 px-2 border border-(--primary) hover:border-gray-300/25 duration-200'>
                                                            <lord-icon src="https://cdn.lordicon.com/vduvxizq.json" trigger="hover" colors="primary:#16c72e" style={{ transform: "rotate(320deg)" }}></lord-icon> Live Demo
                                                        </a>
                                                    </div>
                                                </div>
                                                <div className={`w-full lg:w-2/3 px-12 mt-6 ${styles.pics}`}>
                        ...
                        <img src={"/screenshots/megamart/1.jpeg"} className='rounded w-full' loading="lazy" alt='Front-end for E-commerce website' />
                    </div>
                    {/* second project */}
                    <div className={`projectBox relative flex justify-between items-center py-6 px-12 rounded-2xl lg:flex-row flex-col-reverse ${styles.projectBox}`}>
                        <div className="text text-white lg:pr4 lg:mt-0 mt-3 text-center lg:text-start">
                            <h3 className='font-bold text-3xl lg:text-5xl mb-3'>Gaming Zone – Gaming News Aggregator</h3>
                            <p className='mb-2 lg:mr-18'>Gaming Zone is a dynamic and responsive web application built with Next.js that aggregates and displays the latest gaming news from multiple trusted sources like IGN, Game Informer, and VG247. Designed for gaming enthusiasts, the platform collects articles via RSS feeds, converts them into structured JSON, and presents them in an engaging and modern UI.</p>
                            <button type="button" onClick={open2} className='bg-transparent rounded-full w-20 h-20'>
                                <lord-icon src="https://cdn.lordicon.com/vduvxizq.json" trigger="hover" colors="primary:#16c72e" style={{ width: "70px", height: "70px", transform: "rotate(320deg)" }}></lord-icon>
                            </button>
                                            ...
                                            <div className="dialog-body flex flex-wrap p-0 text-left">
                                                <div className={`description w-full lg:w-1/3 lg:pl-12 py-6 px-12 sticky top-0 text-white ${styles.description}`}>
                                                    ...
                                                    <div className={`inline-flex flex-wrap gap-6 pt-6 mb-6 lg:mb-0 ${styles.btnGroup}`}>
                                                        ...
                                                        <a href='megamart1.vercel.app/' target='_blank' className='text-white flex items-center rounded-3xl p-1 px-2 border border-(--primary) hover:border-gray-300/25 duration-200'>
                                                            <lord-icon src="https://cdn.lordicon.com/vduvxizq.json" trigger="hover" colors="primary:#16c72e" style={{ transform: "rotate(320deg)" }}></lord-icon> Live Demo
                                                        </a>
                                                    </div>
                                                </div>
                        ...
                        <img src={"/screenshots/gaming-zone/1.jpeg"} className='rounded w-full' loading="lazy" alt='Gaming News Aggregator Website' />
                    </div>
                    ...
                    <div className={`projectBox relative flex justify-between items-center py-6 px-12 rounded-2xl lg:flex-row flex-col-reverse ${styles.projectBox}`}>
                        <div className="text text-white lg:pr4 lg:mt-0 mt-3 text-center lg:text-start">
                            ...
                            <p className='mb-2 lg:mr-18'>Mohid is a responsive, single-page landing site prototype for an online smartwatch store. Built with Bootstrap and custom CSS, it showcases featured brands, highlights the latest products, includes customer testimonials, and invites visitors to subscribe to a newsletter.</p>
                            <button type="button" onClick={open3} className='bg-transparent rounded-full w-20 h-20'>
                                <lord-icon src="https://cdn.lordicon.com/vduvxizq.json" trigger="hover" colors="primary:#16c72e" style={{ width: "70px", height: "70px", transform: "rotate(320deg)" }}></lord-icon>
                            </button>
                        ...
                        <img src={"/screenshots/mohid/1.jpeg"} className='rounded w-full' loading="lazy" alt='Smartwatch E-Commerce Front-End' />
                    </div>
                </div>
            </section>
        </>
