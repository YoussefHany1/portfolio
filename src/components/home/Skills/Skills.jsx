...
function Skills() {
  return (
    <>
      <section className={`skills py-3 mb-10 mb-5 border-t border-gray-300/25 ${styles.skills}`}>
        ...
        <div className="skills-content flex overflow-hidden py-3">
          ...
          >
            <SplideSlide className={`skillBox flex justify-center p-4 border border-gray-300/25 items-center ${styles.skillBox}`}>
              <svg
                viewBox="0 0 32 32">
