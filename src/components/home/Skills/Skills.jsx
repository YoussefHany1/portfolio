  ...
  return (
    <>
      <section className='skills py-3 mb-10 border-t border-gray-300/25'>
        <h2 className='uppercase text-white text-3xl mt-5 font-bold text-center md:text-start lg:px-12 mb-6'>Skills</h2>
        <div className="skills-content flex overflow-hidden py-3">
          <Splide options={{
            type: 'loop', gap: '1rem', drag: 'free', arrows: false, pagination: false, perPage: 5, autoScroll: { speed: 2, pauseOnHover: false },
          ...
          >
            <SplideSlide className='skill-box flex justify-center p-4 border border-gray-300/25 items-center lg:!w-150 !w-72'>
              <svg
                ...
                <path d="M16 13.407h-4.09l-.282-3.165H16V7.151H8.25l.074.83.759 8.517H16zm0 8.027-.014.004-3.442-.929-.22-2.465H9.221l.433 4.852 6.332 1.758.014-.004z" fill='#ebebeb' />
              ...
              <p className='uppercase text-white font-bold text-3xl ml-4'>HTML</p>
            </SplideSlide>
            ...
            <SplideSlide className='skill-box flex justify-center p-4 border border-gray-300/25 items-center lg:!w-150 !w-72'>
              <svg
                ...
                <path d="M16 13.191h4.09l.282-3.165H16V6.935h7.75l-.074.829-.759 8.518H16z" fill='#fff' />
                <path d="m16.019 21.218-.014.004-3.442-.93-.22-2.465H9.24l.433 4.853 6.331 1.758.015-.004z" fill='#ebebeb' />
                <path d="m19.827 16.151-.372 4.139-3.447.93v3.216l6.336-1.756.047-.522.537-6.007z" fill='#fff' />
                <path d="M16.011 6.935v3.091H8.545l-.062-.695-.141-1.567-.074-.829zM16 13.191v3.091h-3.399l-.062-.695-.14-1.567-.074-.829z" fill='#ebebeb' />
              </svg>
              <p className='uppercase text-white font-bold text-3xl ml-4'>CSS</p>
            </SplideSlide>
            ...
            <SplideSlide className='skill-box flex justify-center p-4 border border-gray-300/25 items-center lg:!w-150 !w-72'>
              ...
              <p className='uppercase text-white font-bold text-3xl ml-4'>JavaScript</p>
            </SplideSlide>
            <SplideSlide className='skill-box flex justify-center p-4 border border-gray-300/25 items-center lg:!w-150 !w-72'>
              <svg
                viewBox="0 0 256 256"
            ...
            <SplideSlide className='skill-box flex justify-center p-4 border border-gray-300/25 items-center lg:!w-150 !w-72'>
              ...
              <p className='uppercase text-white font-bold text-3xl ml-4'>Bootstrap</p>
            </SplideSlide>

            <SplideSlide className='skill-box flex justify-center p-4 border border-gray-300/25 items-center lg:!w-150 !w-72'>
              <svg viewBox="0 0 32 32" style={{ width: '50px', height: '50px' }} fill="#44a8b3"><path d="M9 13.7q1.4-5.6 7-5.6c5.6 0 6.3 4.2 9.1 4.9q2.8.7 4.9-2.1-1.4 5.6-7 5.6c-5.6 0-6.3-4.2-9.1-4.9q-2.8-.7-4.9 2.1m-7 8.4q1.4-5.6 7-5.6c5.6 0 6.3 4.2 9.1 4.9q2.8.7 4.9-2.1-1.4 5.6-7 5.6c-5.6 0-6.3-4.2-9.1-4.9q-2.8-.7-4.9 2.1" /></svg>
              <p className='uppercase text-white font-bold text-3xl ml-4'>tailwind css</p>
            </SplideSlide>
            ...
            <SplideSlide className='skill-box flex justify-center p-4 border border-gray-300/25 items-center lg:!w-150 !w-72'>
              ...
              <p className='uppercase text-white font-bold text-3xl ml-4'>React</p>
            </SplideSlide>

            <SplideSlide className='skill-box flex justify-center p-4 border border-gray-300/25 items-center lg:!w-150 !w-72'>
              <svg viewBox="0 0 15 15" style={{ width: '50px', height: '50px' }}><path fillRule="evenodd" fill='white' clipRule="evenodd" d="M0 7.5a7.5 7.5 0 1 1 11.698 6.216L4.906 4.21A.5.5 0 0 0 4 4.5V12h1V6.06l5.83 8.162A7.5 7.5 0 0 1 0 7.5M10 10V4h1v6z" /></svg>
              <p className='uppercase text-white font-bold text-3xl ml-4'>Next.js</p>
            </SplideSlide>

            <SplideSlide className='skill-box flex justify-center p-4 border border-gray-300/25 items-center lg:!w-150 !w-72'>
              <svg viewBox="0 0 32 32" style={{ width: '50px', height: '50px' }}><path d="M29.472 14.753 17.247 2.528a1.8 1.8 0 0 0-2.55 0l-2.539 2.539 3.22 3.22a2.141 2.141 0 0 1 2.712 2.73l3.1 3.1a2.143 2.143 0 1 1-1.285 1.21l-2.895-2.895v7.617a2.141 2.141 0 1 1-1.764-.062V12.3a2.146 2.146 0 0 1-1.165-2.814l-3.17-3.172L2.528 14.7a1.8 1.8 0 0 0 0 2.551l12.225 12.221a1.8 1.8 0 0 0 2.55 0L29.472 17.3a1.8 1.8 0 0 0 0-2.551" fill='#dd4c35' />
              ...
              <p className='uppercase text-white font-bold text-3xl ml-4'>Git</p>
            </SplideSlide>
